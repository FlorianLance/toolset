...
//static constexpr std::array<std::pair<k4abt_joint_id_t, k4abt_joint_id_t>, 31> g_boneList =
//{
...
//static inline std::unordered_map<k4abt_joint_id_t, std::string_view> g_jointNames =
//{
...
//static constexpr std::array<Color, 20> g_bodyColors =
//{
//Color{0.00f, 1.00f, 1.00f, 1.00f},
