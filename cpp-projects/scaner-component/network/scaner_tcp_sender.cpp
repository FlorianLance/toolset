...
ScanerTcpSender::ScanerTcpSender(size_t id, std::vector<Interface> *localInterfaces): m_p(std::make_unique<Impl>()){
...
bool ScanerTcpSender::enable_writing(std::string targetName, int writingPort, size_t readingInterface, int readingPort){
...
void ScanerTcpSender::disable_writing(){
...
void ScanerTcpSender::init_command(int targetWritingPort, std::string targetWritingIpAddress){
...
void ScanerTcpSender::open_camera_command(K2FrameRequest mode){
...
void ScanerTcpSender::close_camera_command(){
...
void ScanerTcpSender::update_settings_command(K2Settings parameters){
...
void ScanerTcpSender::ask_new_frame_command(){
...
void ScanerTcpSender::set_size_udp_packets(int size){
    std::unique_lock<std::mutex> lock(m_p->locker);
    m_p->sizeUdpPackets = size;
}

size_t ScanerTcpSender::reading_interface() const{
...
void ScanerTcpSender::write_data(){
